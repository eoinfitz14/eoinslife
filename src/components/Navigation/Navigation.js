  ...
  return (
    <header className='bg-white black-80 tc pv4 avenir'>
      ...
      <nav className='bt bb tc mw7 center mt4'>
        ...
        <a className='f6 f5-l link bg-animate black-80 hover-bg-light-green dib pa3 ph4-l' href='/portfolio'>Education</a>
        <a className='f6 f5-l link bg-animate black-80 hover-bg-light-blue dib pa3 ph4-l' href='/shop'>Work Experience</a>
        <a className='f6 f5-l link bg-animate black-80 hover-bg-light-pink dib pa3 ph4-l' href='/about'>Skills</a>
        <a className='f6 f5-l link bg-animate black-80 hover-bg-light-yellow dib pa3 ph4-l' href='/contact'>Testimonials</a>
      </nav>
    </header>
  );
}
